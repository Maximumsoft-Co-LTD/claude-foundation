# host-agent-contract Specification

## Purpose
TBD - created by archiving change expose-the-package-owned-foundation-agent-contract-through-a-ver. Update Purpose after archive.
## Requirements
