...
:::note[Version]
These docs track Foundation **v3.4.2** — runtime API 25, provider protocol 10. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
