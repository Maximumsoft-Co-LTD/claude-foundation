...
:::note[Version]
These docs track Foundation **v3.2.19** — runtime API 18, provider protocol 7. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
