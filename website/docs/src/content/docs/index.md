...
:::note[Version]
These docs track Foundation **v3.4.4** — runtime API 26, provider protocol 12. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
