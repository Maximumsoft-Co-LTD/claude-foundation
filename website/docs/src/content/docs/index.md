...
:::note[Version]
These docs track Foundation **v3.3.0** — runtime API 24, provider protocol 10. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
