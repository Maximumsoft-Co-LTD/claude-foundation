...
:::note[Version]
These docs track Change Loop **v3.5.4** — runtime API 28, provider protocol 13. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
