...
:::note[Version]
These docs track Change Loop **v3.5.16** — runtime API 35, provider protocol 13. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
