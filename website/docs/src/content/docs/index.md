...
:::note[Version]
These docs track Foundation **v3.2.32** — runtime API 22, provider protocol 8. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
