...
:::note[Version]
These docs track Change Loop **v3.5.12** — runtime API 32, provider protocol 13. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
