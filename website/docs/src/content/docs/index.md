...
:::note[Version]
These docs track Change Loop **v3.5.25** — runtime API 41, provider protocol 13. Receipts recorded by earlier versions read as `provider-version-stale` and must be re-proven.
:::
