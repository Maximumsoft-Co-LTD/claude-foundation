...
มีสองคุณสมบัติกำหนดว่าใครรีวิวได้

**ความเป็นอิสระยกเว้นไม่ได้เลย** ตัวตนของผู้รีวิวต้องต่างจากผู้ implement ทุกคน
และ session ของ AI ผู้รีวิวต้องต่างจาก session ของ AI ผู้ implement ทุกตัว
ไม่มีอะไรรีวิวตัวเองได้

**ความหลากหลายยกเว้นได้ แต่ต้องเห็น** โดยปกติ AI ผู้รีวิวต้องมาจากคนละ provider
...
`diversity-waived-single-model` ลงในนโยบาย เพื่อให้การยกเว้นปรากฏในบันทึก
ไม่ใช่ซ่อนอยู่ใน config
