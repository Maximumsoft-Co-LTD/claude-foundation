...
:::note[เวอร์ชัน]
เอกสารชุดนี้อ้างอิง Change Loop **v3.5.0** — runtime API 26, provider protocol 13 receipt ที่บันทึกด้วยเวอร์ชันก่อนหน้าจะอ่านได้เป็น `provider-version-stale` และต้องพิสูจน์ใหม่
:::
