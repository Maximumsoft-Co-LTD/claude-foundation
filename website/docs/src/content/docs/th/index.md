...
Change Loop ไม่ใช่ AI และไม่ได้เขียนโค้ดเอง มันเป็น control plane แบบ deterministic ที่ครอบ coding agent ของคุณอีกที และไม่ได้มาแทน agent, test framework, CI หรือ Git workflow เดิม — มันสั่งเครื่องมือที่รีโปคุณมีอยู่แล้ว
...
Change Loop จงใจแยกความรับผิดชอบ เพื่อไม่ให้ฝ่ายใดฝ่ายหนึ่งทั้งทำงานเองและรับรองงานตัวเอง
...
:::note[เวอร์ชัน]
เอกสารชุดนี้อ้างอิง Change Loop **v3.5.10** — runtime API 32, provider protocol 13 receipt ที่บันทึกด้วยเวอร์ชันก่อนหน้าจะอ่านได้เป็น `provider-version-stale` และต้องพิสูจน์ใหม่
:::
