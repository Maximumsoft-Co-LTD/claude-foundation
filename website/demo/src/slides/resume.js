...
const SCRIPT = [
  ...
  { phase: "phase-2-implementation", step: "implement", next: "test", agent: "engineer" },
  { phase: "phase-2-implementation", step: "test", next: "review", agent: "qa", cycle: "test" },
  { phase: "phase-2-implementation", step: "review", next: "docs", agent: "lead", cycle: "review" },
