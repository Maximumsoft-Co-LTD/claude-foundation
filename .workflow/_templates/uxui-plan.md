...
- **Actor:** <who> · **Precondition:** <what must be true> · **Satisfies:** AC1, AC2
...
<!--
This is a clean skeleton. The hard rules — states first-class, no orphan scenes/scenarios, every AC mapped,
don't invent the unhappy path, reuse before invention, [NEEDS CLARIFICATION] for open requirement-level UX:
see  uxui.md > What goes in each section + Steps.
-->
