...
- Fixtures / test data / environment — what a run needs: real test DB vs in-memory, seed / fixture data, which boundaries run real vs doubled, env vars / external services. (No mocking the database in integration tests — see qa.md Rules.)
