...
**Status**: pending | passing | failing | skipped · **Cycle**: 1 of max 3
...
<!--
Fill only the active mode's sections; delete the rest (no "N/A"):
Acceptance-criteria coverage · Regression test (fix) · Baseline (refactor / brownfield feat) · Edge-case gaps ·
