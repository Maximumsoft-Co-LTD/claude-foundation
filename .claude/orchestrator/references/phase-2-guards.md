...
> Loaded on demand by the main agent (`.claude/orchestrator.md`). The Phase-2 step *decisions* stay inline (steps 10–16); this holds the deep scan/guard mechanics. Read it at the step it names.
