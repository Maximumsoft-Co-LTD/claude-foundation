...
**Steps:**
1. Read plan + spec + diff. (Review-fanout tiering — core 3 at M, full 6 at L/high-stakes → `references/lead.md > Review fanout`.)
...
## Mode C — Security review (Phase 2 step 6, trigger-based only)
