...
!openspec native benchmark|node --test --test-concurrency=1 "$ROOT/.claude/tests/bench/tests/openspec-native-scorecard.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-runner.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-lab.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-workloads.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-aggregate.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-sentinel.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-release-report.test.mjs"
...
change draft materialization|node --test "$ROOT/.claude/harness/tests/change-draft-materialization.test.mjs" "$ROOT/.claude/harness/tests/semantic-draft.test.mjs" "$ROOT/.claude/harness/tests/design-blueprints.test.mjs" "$ROOT/.claude/harness/tests/semantic-intake.test.mjs" "$ROOT/.claude/harness/tests/semantic-intake-state.test.mjs" "$ROOT/.claude/harness/tests/semantic-source-inventory.test.mjs" "$ROOT/.claude/harness/tests/semantic-intake-intelligence.test.mjs" "$ROOT/.claude/harness/tests/repository-intelligence.test.mjs" "$ROOT/.claude/harness/tests/investigation-runtime.test.mjs" "$ROOT/.claude/harness/tests/amendment-invalidation.test.mjs" "$ROOT/.claude/harness/tests/selective-proof-plan.test.mjs"
...
repository delivery saga|node --test "$ROOT/.claude/harness/tests/repository-delivery-saga.test.mjs"
...
advance lifecycle outcomes|node --test "$ROOT/.claude/harness/tests/advance-runtime.test.mjs" "$ROOT/.claude/harness/tests/delivery-convergence.test.mjs" "$ROOT/.claude/harness/tests/user-decisions.test.mjs" "$ROOT/.claude/harness/tests/target-edits.test.mjs"
