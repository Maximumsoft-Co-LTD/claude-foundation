...
!openspec native benchmark|node --test "$ROOT/.claude/tests/bench/tests/openspec-native-scorecard.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-runner.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-lab.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-workloads.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-aggregate.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-sentinel.test.mjs" "$ROOT/.claude/tests/bench/tests/openspec-native-release-report.test.mjs"
