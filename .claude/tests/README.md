...
| `harness/run-proof-loop-tests.sh` | Executable-provider proof, selective amendment receipt reuse, amended worktree replay and automatic Land recovery to archive with unchanged target HEAD/index |
