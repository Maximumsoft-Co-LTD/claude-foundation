...
| `.claude/harness/tests/semantic-draft.test.mjs` + semantic intake/intelligence/investigation/state/source/invalidation tests | Semantic draft v3 compatibility, v4 discovery coverage, source-bound Investigate state and Change handoff, bounded repository intelligence, adaptive multilingual-neutral intake, question-quality and effectiveness measurements, source freshness, fail-closed selective proof recovery, stable links, canonical MODIFIED scenario merge, typed integration documentation, conditional artifacts, Grounding-compatible compilation, and transactional rollback/preservation |
