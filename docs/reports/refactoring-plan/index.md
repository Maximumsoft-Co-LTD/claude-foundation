...
- Production functions planned: 3388
- Source commit: `6964636c591b4c37f3637a03ce1ad8925be587f3`
...
| W3 | Remaining CRAP failures | 108 |
| W4 | Warning functions: test and simplify when touched | 59 |
| W5 | Passing but below changed-code coverage floor | 822 |
| Continuous | Healthy functions to preserve | 2379 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2784 | 72 | 36 | 0 | [Open](./runtime.md) |
