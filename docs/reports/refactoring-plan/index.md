...
- Production functions planned: 3382
- Source commit: `be04223664c31da189e6f65a02545feb0aa4352c`
...
| W3 | Remaining CRAP failures | 112 |
| W4 | Warning functions: test and simplify when touched | 60 |
| W5 | Passing but below changed-code coverage floor | 829 |
| Continuous | Healthy functions to preserve | 2361 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2778 | 76 | 37 | 0 | [Open](./runtime.md) |
