...
- Production functions planned: 3387
- Source commit: `bf03a8ef0a869d01609bf2afbb37e62189fe8dea`
...
| W3 | Remaining CRAP failures | 104 |
| W4 | Warning functions: test and simplify when touched | 57 |
| W5 | Passing but below changed-code coverage floor | 813 |
| Continuous | Healthy functions to preserve | 2393 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2783 | 68 | 34 | 0 | [Open](./runtime.md) |
