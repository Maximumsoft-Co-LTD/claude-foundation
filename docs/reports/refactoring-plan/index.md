...
- Production functions planned: 3473
- Source commit: `29b80f3eaa1cf40e23ba0c68476b36b9c44c1684`
...
| W3 | Remaining CRAP failures | 45 |
| W4 | Warning functions: test and simplify when touched | 39 |
| W5 | Passing but below changed-code coverage floor | 722 |
| Continuous | Healthy functions to preserve | 2653 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2869 | 3 | 16 | 0 | [Open](./runtime.md) |
