...
- Source commit: `4a27dba6861a0c784904c3d8ed2b874c0a5a46ef`
...
| W3 | Remaining CRAP failures | 124 |
| W4 | Warning functions: test and simplify when touched | 61 |
| W5 | Passing but below changed-code coverage floor | 839 |
| Continuous | Healthy functions to preserve | 2329 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2770 | 89 | 38 | 0 | [Open](./runtime.md) |
