...
- Production functions planned: 3230
- Source commit: `64564d58b1d6400e6689538bed523e0533cd2842`
...
| W2 | High-risk refactors | 71 |
| W3 | Remaining CRAP failures | 157 |
| W4 | Warning functions: test and simplify when touched | 72 |
| W5 | Passing but below changed-code coverage floor | 1029 |
| Continuous | Healthy functions to preserve | 1901 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2630 | 167 | 49 | 0 | [Open](./runtime.md) |
