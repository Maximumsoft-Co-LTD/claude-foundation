...
- Source commit: `95d507b35064d99505f46ec08a072be2f00275ad`
...
| W4 | Warning functions: test and simplify when touched | 46 |
| W5 | Passing but below changed-code coverage floor | 797 |
| Continuous | Healthy functions to preserve | 2449 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2790 | 46 | 23 | 0 | [Open](./runtime.md) |
