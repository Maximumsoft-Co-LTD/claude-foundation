...
- Production functions planned: 3277
- Source commit: `404f219d3cfb851207783f502d87b0231ec8e423`
...
| W2 | High-risk refactors | 48 |
| W3 | Remaining CRAP failures | 151 |
| W4 | Warning functions: test and simplify when touched | 70 |
| W5 | Passing but below changed-code coverage floor | 988 |
| Continuous | Healthy functions to preserve | 2020 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2685 | 142 | 47 | 0 | [Open](./runtime.md) |
