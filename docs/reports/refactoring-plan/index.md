...
- Production functions planned: 3374
- Source commit: `9c79f92d29c06f30c544284fd5170869cd78ce2b`
...
| W2 | High-risk refactors | 23 |
| W3 | Remaining CRAP failures | 127 |
| W4 | Warning functions: test and simplify when touched | 62 |
| W5 | Passing but below changed-code coverage floor | 852 |
| Continuous | Healthy functions to preserve | 2310 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2770 | 94 | 39 | 0 | [Open](./runtime.md) |
