...
- Source commit: `438c0a927ab9c0d4cb9716cc6021f201f243afa7`
...
| W3 | Remaining CRAP failures | 86 |
| W4 | Warning functions: test and simplify when touched | 51 |
| W5 | Passing but below changed-code coverage floor | 806 |
| Continuous | Healthy functions to preserve | 2430 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2789 | 50 | 28 | 0 | [Open](./runtime.md) |
