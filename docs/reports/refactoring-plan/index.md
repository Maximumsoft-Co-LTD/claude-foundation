...
- Production functions planned: 3249
- Source commit: `da9e180bda97289389669cbe0dc93f2be07da6f4`
...
| W2 | High-risk refactors | 65 |
| W3 | Remaining CRAP failures | 154 |
| W4 | Warning functions: test and simplify when touched | 72 |
| W5 | Passing but below changed-code coverage floor | 1020 |
| Continuous | Healthy functions to preserve | 1938 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2643 | 161 | 49 | 0 | [Open](./runtime.md) |
| dashboard | 389 | 41 | 16 | 0 | [Open](./dashboard.md) |
