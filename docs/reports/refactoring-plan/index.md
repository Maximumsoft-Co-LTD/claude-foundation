...
- Production functions planned: 3361
- Source commit: `3009b6034cb57bd850e4bc02123f1aa5ddeb723b`
...
| W3 | Remaining CRAP failures | 147 |
| W4 | Warning functions: test and simplify when touched | 68 |
| W5 | Passing but below changed-code coverage floor | 908 |
| Continuous | Healthy functions to preserve | 2210 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2757 | 119 | 45 | 0 | [Open](./runtime.md) |
