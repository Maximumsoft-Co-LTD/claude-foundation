...
- Production functions planned: 3419
- Source commit: `caa3bbc0eb490d66ab5c1c953c054797be1d0fcf`
...
| W3 | Remaining CRAP failures | 58 |
| W4 | Warning functions: test and simplify when touched | 39 |
| W5 | Passing but below changed-code coverage floor | 743 |
| Continuous | Healthy functions to preserve | 2562 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2815 | 19 | 16 | 0 | [Open](./runtime.md) |
