...
- Production functions planned: 3199
- Source commit: `b7826c9451b9ddd03705dc0a3740a170de59f7c9`
...
| W2 | High-risk refactors | 77 |
| W3 | Remaining CRAP failures | 158 |
| W4 | Warning functions: test and simplify when touched | 73 |
| W5 | Passing but below changed-code coverage floor | 1048 |
| Continuous | Healthy functions to preserve | 1843 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2613 | 172 | 50 | 0 | [Open](./runtime.md) |
