...
- Production functions planned: 3289
- Source commit: `a0aa883849db4eef56c51037f8bd006b67c399aa`
...
| W2 | High-risk refactors | 43 |
| W3 | Remaining CRAP failures | 151 |
| W4 | Warning functions: test and simplify when touched | 69 |
| W5 | Passing but below changed-code coverage floor | 973 |
| Continuous | Healthy functions to preserve | 2053 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2697 | 137 | 46 | 0 | [Open](./runtime.md) |
