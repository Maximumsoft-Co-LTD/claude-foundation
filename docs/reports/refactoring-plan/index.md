...
- Source commit: `bb70b9cc738bec0f760a9afc7f429d518ef7d5c6`
...
| W4 | Warning functions: test and simplify when touched | 47 |
| W5 | Passing but below changed-code coverage floor | 797 |
| Continuous | Healthy functions to preserve | 2447 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2789 | 46 | 24 | 0 | [Open](./runtime.md) |
