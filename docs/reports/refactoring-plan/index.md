...
- Production functions planned: 3401
- Source commit: `5db0e4494f9deb29a7edad6660bdc56928cb8729`
...
| W2 | High-risk refactors | 18 |
| W3 | Remaining CRAP failures | 64 |
| W4 | Warning functions: test and simplify when touched | 39 |
| W5 | Passing but below changed-code coverage floor | 775 |
| Continuous | Healthy functions to preserve | 2505 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2797 | 26 | 16 | 0 | [Open](./runtime.md) |
