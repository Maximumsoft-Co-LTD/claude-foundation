...
- Production functions planned: 3435
- Source commit: `3653c5aa1826ff55a97adb48753b98c138e14dd1`
...
| W2 | High-risk refactors | 16 |
| W3 | Remaining CRAP failures | 54 |
| W4 | Warning functions: test and simplify when touched | 39 |
| W5 | Passing but below changed-code coverage floor | 735 |
| Continuous | Healthy functions to preserve | 2591 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2831 | 14 | 16 | 0 | [Open](./runtime.md) |
