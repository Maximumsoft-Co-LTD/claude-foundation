...
- Source commit: `725f50bd4ce1120ac04ace57a51757d5ca302a6b`
...
| W4 | Warning functions: test and simplify when touched | 48 |
| W5 | Passing but below changed-code coverage floor | 797 |
| Continuous | Healthy functions to preserve | 2446 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2789 | 46 | 25 | 0 | [Open](./runtime.md) |
