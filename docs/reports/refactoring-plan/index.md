...
- Production functions planned: 3483
- Source commit: `d178395d326a02d060e74fa315a73372ce87c8e3`
...
| W4 | Warning functions: test and simplify when touched | 35 |
| W5 | Passing but below changed-code coverage floor | 720 |
| Continuous | Healthy functions to preserve | 2670 |

## Surface plans

| Surface | Functions | Fail | Warn | Unmapped | Plan |
|---|---:|---:|---:|---:|---|
| runtime | 2879 | 2 | 12 | 0 | [Open](./runtime.md) |
